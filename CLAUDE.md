...
**Prefer span attributes over logs.** Every endpoint handler should enrich the current span with attributes that would help a support engineer diagnose an issue without needing to reproduce it. Ask: *what would I wish I knew when investigating this at 2am?*
